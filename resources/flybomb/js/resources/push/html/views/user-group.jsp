...
<head>
	...
	<link rel="stylesheet" href="http://push-res.mzres.com/resources/push/css/base.css">
	<link rel="stylesheet" href="http://push-res.mzres.com/resources/push/css/userGroup.css">
<link href="http://push-res.mzres.com/resources/push/dist/common.css?ver=<%= jsVersion%>" rel="stylesheet"></head>
<body>
<div id="j_wraper" class="hide">
	...
	<script src="http://push-res.mzres.com/resources/push/js/user-group/jquery.min.js"></script>
	<script src="http://push-res.mzres.com/resources/push/js/user-group/jquery.tmpl.min.js"></script>
	<script src="http://push-res.mzres.com/resources/push/js/user-group/json2.js"></script>
	<script src="http://push-res.mzres.com/resources/push/js/user-group/tools.js"></script>
	<script src="http://push-res.mzres.com/resources/push/js/user-group/common.js"></script>
	<script src="http://push-res.mzres.com/resources/push/js/user-group/jquery.validate.js"></script>
	<script src="http://push-res.mzres.com/resources/push/js/user-group/userGroup.js"></script>
	<!-- dev start
...
<script type="text/javascript" src="http://push-res.mzres.com/resources/push/dist/vender.js?ver=<%= jsVersion%>"></script><script type="text/javascript" src="http://push-res.mzres.com/resources/push/dist/push.js?ver=<%= jsVersion%>"></script><script type="text/javascript" src="http://push-res.mzres.com/resources/push/dist/main.js?ver=<%= jsVersion%>"></script></body>
</html>